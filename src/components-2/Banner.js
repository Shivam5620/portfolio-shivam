            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <h1 style={{ height: "8rem", color: "white" }}>{`Hi! I'm Shivam Birla`} <br /><span className="txt-rotate" dataPeriod="1000" data-rotate='["React Developer" ,"Web Developer", "Web Designer", "MERN STACK DEVELOPER" ]'><span className="wrap">{text}</span></span></h1>
